package com.example.testappsmartstaff.customView
...
import com.example.testappsmartstaff.R
...
class MyImageView : AppCompatImageView, Runnable {
    ...
    private var list = com.example.testappsmartstaff.mylist.Utils.list
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        currentPos = -1
        com.example.testappsmartstaff.mylist.Utils.list.clear()
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        when (event.action) {
            MotionEvent.ACTION_DOWN -> list.add(com.example.testappsmartstaff.models.Result(touchX.toInt(), touchY.toInt(), true))
            MotionEvent.ACTION_MOVE -> list.add(com.example.testappsmartstaff.models.Result(touchX.toInt(), touchY.toInt()))
            MotionEvent.ACTION_UP -> list.add(Result(touchX.toInt(), touchY.toInt()))
            else -> return false
        }
